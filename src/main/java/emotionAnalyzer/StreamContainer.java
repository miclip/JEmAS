...
public class StreamContainer {
	...
	final InputStream normalizedDocument;
	...
	public StreamContainer(InputStream givenDocument, InputStream givenNormalizedDocument, InputStream givenDocumentTermVector
			) {
		...
		this.normalizedDocument = givenNormalizedDocument;

		this.non_stopword_tokenCount = -1; 
		this.documentTermVector = givenDocumentTermVector;
	}
	
	final InputStream documentTermVector;
...
//}
	...
	public int[] getDocumentTermVector() throws IOException{
		List<String> vecList = Util.readStream2List(this.documentTermVector);
